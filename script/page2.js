...
const pages = {
    about:    "<h1>About Me</h1><p>你的说明内容...</p>",
    background:      "<h1>Background and Skill</h1><p>你的说明内容...</p>",
    project: "<h1>Project</h1><p>你的说明内容...</p>",
    ...
    contact:    "<h1>Contact</h1><p>你的说明内容...</p>",

    profile:  "<div class='profile'><div class='whole-img'><img class='cover-img' usemap='#image-map' src='./images/me-nbg.png'><span class='name-text'>KennyCS</span><img class='inside-img' src='./images/me-nbg-inside.png'></div><p>你的自我介绍内容...</p></div>"
};
